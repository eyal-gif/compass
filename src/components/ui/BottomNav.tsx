...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 border-t border-border bg-bg-surface pb-[env(safe-area-inset-bottom)]">
        ...
        {tabs.map(({ href, label, icon }) => {
          ...
          return (
            <Link
              key={href}
              href={href}
              className={`flex flex-1 flex-col items-center gap-0.5 py-2.5 text-xs font-body transition-colors duration-150 ${
                isActive ? 'text-accent font-medium' : 'text-warm-gray'
              }`}
            >
